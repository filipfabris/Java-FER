...
public class InputUserDataPanel extends JPanel {
	private String[] cityArray = { "Zagreb", "Osijek", "Rijeka", "Split", "Dubrovnik", "Zadar", "Šibenik", "Pula" };
	...
	public InputUserDataPanel() {
		...
		radioPanel.setBorder(BorderFactory.createTitledBorder(null, "Kako želite primati e-mailove?",
	...
	public void setUserData(UserData userData) {
		...
		if (userData.getEmailType() != null) {
			...
			case MONTHLY:
				...
				break;
			default:
				throw new RuntimeException("UserData.EmailType is not recognized: type=" + userData.getEmailType());
			}
		} else {
